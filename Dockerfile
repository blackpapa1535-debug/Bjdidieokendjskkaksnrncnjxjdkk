...
# WALLPAPER
# =========================================================
# Put your RAW GitHub image URL here.
# Example:
# https://raw.githubusercontent.com/USER/REPO/main/kali-wallpaper.jpg
...
RUN printf '%s\n' \
    ...
    \
    'if [ -n "$WALLPAPER_URL" ] && [ "$WALLPAPER_URL" != "https://github.com/blackpapa1535-debug/Bjdidieokendjskkaksnrncnjxjdkk/blob/main/kali-wallpaper.jpg" ]; then' \
    ...
    'Exec=sh -c "sleep 1; pgrep -x xfce4-panel >/dev/null || xfce4-panel"' \
    'OnlyShowIn=XFCE;' \
